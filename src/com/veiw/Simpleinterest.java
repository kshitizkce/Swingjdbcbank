...
public class Simpleinterest extends JFrame {
	...
	public Simpleinterest() {
		...
		JLabel lblNewLabel = new JLabel("Simple Interest calculator");
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 26));
		lblNewLabel.setBounds(215, 29, 399, 47);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Enter Principal");
		...
		JLabel lblNewLabel_1_1_1_1 = new JLabel("Calculated Simple Interest");
