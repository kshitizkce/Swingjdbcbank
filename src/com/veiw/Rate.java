...
public class Rate extends JFrame {
	...
	public Rate() {
		...
		JLabel lblNewLabel = new JLabel("Rate calculator");
		...
		JLabel lblNewLabel_1_1_1_1 = new JLabel("Calculated Rate");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String r=String.valueOf((si*100)/(p*t));
				textField_3.setText(r);
